...
class TestResultQueAnsPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => new _State();

  TestResultQueAnsPage(String mysubtest_id, String my_test_id) {
    mysubtest_id1 = mysubtest_id;
    my_test_id1 = my_test_id;
    print("mysubtest_id1$mysubtest_id1");
    print("mysubtest_id1my_test_id1 $my_test_id1");
  }
}

class _State extends State<TestResultQueAnsPage> {
  ...
  Future<Album> _getTestResult() async {
    ...
    Map data = {"mysubtest_id": mysubtest_id1, "my_test_id": my_test_id1};
    print("parameter>>$data");
    final response = await http.post(uidata.mysubtestresult,
    ...
    if (response.statusCode == 200) {
      ...
      //  var res = Album.fromJson(jsonDecode(response.bodyBytes));

      // jsonData = json.decode(utf8.decode(res.bodyBytes));
      //   jsonData = json.decode(utf8.decode(res.bodyBytes));
      status = jsonData['status'];
      print("status>>$status");
      attempt = jsonData['attempt'];
            ...
            FlatButton(
              ...
              onPressed: () {
                ...
                if (editingController.text.isEmpty) {
                  ...
                  apiReport(
                      userId, queId, mysubtest_id, editingController.text);
                }
              },
            ),
          ],
                                          ...
                                          Container(
                                            ...
                                            child: Column(
                                              ...
                                              children: <Widget>[
                                                ...
                                                Padding(
                                                  padding: const EdgeInsets.only(left: 5, top: 12, right: 0,
                                                  ),
                                                  child: Row(
                                                    mainAxisAlignment:
                                                        MainAxisAlignment.start,
...
/*                                                  Padding(
  ...
  apiReport(String user_id, String question_id, String mysubtest_id,
    ...
    print("Report>>$data");
    var jsonData = null;
    var response = await http.post(uidata.mysubtestreport,
        body: data, headers: {'Authorization': token});
